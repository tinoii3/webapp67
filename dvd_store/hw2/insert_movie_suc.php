...
<body>
    ...
    <div class="container mt-5">
        <?php
        require 'conn.php';
        $sql_update = "INSERT INTO movie(movie_id,title,genre,price,stock) VALUES ('$_POST[movie_id]','$_POST[title]','$_POST[genre]' ,'$_POST[price]' ,'$_POST[stock]')";
        ...
        if (!$result) {
            ...
            echo "Edit Success";
            echo '</div>';
            header("refresh: 1; url=movie_main.php");
        }
        echo '</div>';
        ?>
    </div>
