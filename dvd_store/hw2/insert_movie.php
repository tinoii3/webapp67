...
<body>
    ...
    <div class="d-flex justify-content-center align-items-center position-absolute top-50 start-50 translate-middle">
        <form method="post" action="insert_movie_suc.php" class="bg-white p-4 rounded shadow text-black">
            <div class="form-group row mb-3">
                <label for="movie_id" class="col-sm-4 col-form-label text-end fs-5 fw-bold">ID</label>
                <div class="col-sm-8">
                    <input type="text" class="form-control bg-gray" name="movie_id" id="movie_id">
                </div>
            </div>
            <div class="form-group row mb-3">
