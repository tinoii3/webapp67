...
<body>
    ...
    <div class="container mt-5">
        ...
        $sql_update = "UPDATE member SET first_name='$_POST[first_name]', last_name='$_POST[last_name]', 
            address='$_POST[address]', telephone='$_POST[telephone]' WHERE member_id='$_POST[member_id]' ";
